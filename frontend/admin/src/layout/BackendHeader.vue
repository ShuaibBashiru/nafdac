...
export default {
        ...
        menus:[
        {"menuName":'addcompany', 'menu_description':'Add company'},
        {"menuName":'uploadproducts', 'menu_description':'Upload products'},
        {"menuName":'listproducts', 'menu_description':'View products'},
        {"menuName":'questioncategory', 'menu_description':'Q&A category'},
        {"menuName":'questions', 'menu_description':'Chatbot Q&A'},
        ],
        mainMenu: [],
        admin_menu: [
