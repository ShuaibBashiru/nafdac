...
<div class="row">
    ...
    <h5 class="text-primary mb-2 ps-2"> Company </h5>
            ...
            <div class="col-md-4">
                ...
                <div class="input-group">
                    ...
                    <input type="text" v-model="company_name" class="form-control" placeholder="Title" required>
                </div>
                </div>
            </div>
     ...
     <div class="col-md-12 ps-0 m-2 mt-2">
            ...
            <div class="table-responsive">
                <table class="table table-hover table-bordered" id="myTable">
                    ...
                    <td> {{index + 1}} </td>
                    <td> {{d['company_name']}} <br> <span class="text-muted">{{d['descriptions']}}</span> </td>
...
export default {
   ...
   tokenize: function(){
    ...
    addNew: function(){
        ...
        axios.post(process.env.VUE_APP_API+'/form/company/addcategory', form)
        .then(response => {
        if(response.data.status==response.data.statusmsg){
